...
This project is indexed by GitNexus as **jira-run-mcp** (320 symbols, 516 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/jira-run-mcp/process/{processName}` — trace the full execution flow step by step
